...
public class Drone : MonoBehaviour {
    ...
    void Update() {
        ...
        //============================미니맵[시작]=====================================
        //MapMarker.transform.position = new Vector3(this.transform.position.x, MapMarker.transform.position.y, this.transform.position.z);
        //MapMarker.transform.forward = this.transform.forward;
    ...
    void FixedUpdate()//일정간격으로 호출한다.
    {
        ...
        if (Drone_ON)
        {
            ...
            Rb.AddRelativeForce(Vector3.forward * 70 * moveJoystickLeft.Vertical());
        }
    }
