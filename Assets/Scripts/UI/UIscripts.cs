...
public class UIscripts : MonoBehaviour {
    ...
    public Text TimeView, NumBoxView, NumCoinView;
    ...
    public void MissionEnd(int Rate, int getExp, int amountMoney, List<int> getPartsId)
    {
        //stopwatch.Reset();
        //1.백그라운드 활성화
        ...
        //============보상출력[시작]=================================================
        RatingView.GetComponent<Rating>().SetRate(Rate);//별 개수
        MissionClearView.GetComponent<MissionReward>().ViewUpdate(SceneData.SceneLevelName, amountMoney, PlayerDataManager.level, PlayerDataManager.exp, getPartsId);//돈과 파츠는 현재 획득한것을 보여준다.
